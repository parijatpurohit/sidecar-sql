...
then
  ...
  protoc --proto_path=github.com/parijatpurohit/sidecar-sql/pb/storage \
  --go_out=plugins=grpc:github.com/parijatpurohit/sidecar-sql/zz_generated/go \github.com/parijatpurohit/sidecar-sql/pb/storage/*.proto
...
then
  ...
  cd github.com/parijatpurohit/sidecar-sql/pb/storage
